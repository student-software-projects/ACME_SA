        ...
        <div class="bg-white p-3 rounded-lg">
            <div class="form-row">
                <div class="form-group col-md-6">
                    ...
                    <input type="text" class="form-control" id="placa" name="placa" value="{{ $vehiculos -> placa }}" disabled>
                </div>
                <div class="form-group col-md-6">
                ...
                <div class="form-group col-md-6">
                    ...
                    @foreach($tipovehi as $vtype)
                        @if($vtype->id == $vehiculos->tipoVehiculos_id)
                            <input type="text" class="form-control" id="tipoVehiculos_id" name="tipoVehiculos_id" value="{{ $vtype -> descTipoVehiculos }}" disabled>
                        @endif
                    @endforeach
                </div>
            </div>
                ...
                <div class="form-group col-md-6">
                    ...
                    @foreach($usuarios as $usu)
                        @if($usu->id == $vehiculos->usuario_con)
                            <input type="text" class="form-control" id="usuario_con" name="usuario_con" value="{{ $usu -> primerNombre }} {{ $usu -> apellidos }}" disabled>
                        @endif
                    @endforeach
                </div>
                <div class="form-group col-md-6">
                    ...
                    @foreach($usuarios as $usu)
                        @if($usu->id == $vehiculos->usuario_pro)
                            <input type="text" class="form-control" id="usuario_pro" name="usuario_pro" value="{{ $usu -> primerNombre }} {{ $usu -> apellidos }}" disabled>
                        @endif
                    @endforeach
                </div>
            </div>
